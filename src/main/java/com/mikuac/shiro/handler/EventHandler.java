...
public class EventHandler {
     ...
     */
    public void handler(@NotNull Bot bot, @NotNull JSONObject eventJson) throws NoSuchPaddingException, IllegalBlockSizeException, NoSuchAlgorithmException, InvalidKeySpecException, BadPaddingException, InvalidKeyException {
     ...
     * @param eventJson 响应数据
     */
    private void handlerMessage(@NotNull Bot bot, @NotNull JSONObject eventJson) throws NoSuchPaddingException, IllegalBlockSizeException, NoSuchAlgorithmException, InvalidKeySpecException, BadPaddingException, InvalidKeyException {
